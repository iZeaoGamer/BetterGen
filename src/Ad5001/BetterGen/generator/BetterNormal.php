...
class BetterNormal extends Generator {
	const NOT_OVERWRITABLE = [Block::STONE, Block::GRAVEL, Block::BEDROCK, Block::DIAMOND_ORE, Block::GOLD_ORE, Block::LAPIS_ORE, Block::REDSTONE_ORE, Block::IRON_ORE, Block::COAL_ORE, Block::WATER, Block::STILL_WATER];
	...
	public function init(ChunkManager $level, Random $random) : void {
		...
		$this->registerBiome(new BetterForest(0, [0.6,
				0.5
		]));
		$this->registerBiome(new BetterForest(1, [0.7,
				0.8
		]));
		...
		if(!\Ad5001\BetterGen\utils\CommonUtils::in_arrayi("Ores", self::$options["delStruct"])) {
			...
			if(Main::isOtherNS())
				$ores->setOreTypes([new OreType2(new CoalOre (), 20, 16, 0, 128), new OreType2(new IronOre (), 20, 8, 0, 64), new OreType2(new RedstoneOre (), 8, 7, 0, 16), new OreType2(new LapisOre (), 1, 6, 0, 32), new OreType2(new GoldOre (), 2, 8, 0, 32), new OreType2(new DiamondOre (), 1, 7, 0, 16), new OreType2(new Dirt (), 20, 32, 0, 128), new OreType2(new Gravel (), 10, 16, 0, 128)]);
			if(!Main::isOtherNS())
